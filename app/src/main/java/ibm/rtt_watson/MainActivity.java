    ...
    private class MicrophoneCallback implements RecognizeCallback {
        ...
        public void onTranscription(SpeechResults speechResults) {
            if (!speechResults.getResults().isEmpty()) {
                final String recognizedText = speechResults.getResults().get(0).getAlternatives().get(0).getTranscript();
                ...
                if (speechResults.isFinal()) {
                    ...
                    new TranslateAndSynthesizeTask().execute(recognizedText, selectedTargetLanguage);
                }
